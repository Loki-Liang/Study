...
namespace LearningASPMVC.Controllers
{
    ...
    {
        private MyStudentEntities1 db = new MyStudentEntities1();
        ...
        public ActionResult Create([Bind(Include = "Sno,Sname,Ssex,Sage,Sdept")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Sno,Sname,Ssex,Sage,Sdept")] Student student)
        {
            if (ModelState.IsValid)
            {
